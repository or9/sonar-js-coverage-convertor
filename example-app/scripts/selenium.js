...
const SELENIUM_OVERRIDES = require(`${process.env.PWD}/package.json`)["selenium-overrides"] || require('../package.json')['selenium-overrides'];
// console.log("running from here", __dirname);
// console.log("nodepath", process.env.NODE_PATH);
// console.log("pwd", process.env.PWD);
function checkSeleniumEnvironment() {
	return __awaiter(this, void 0, void 0, function* () {
		try {
			console.log("yield which java");
			yield promisify(which)('java');
			return;
		}
		catch (error) {
			console.error("caught error which java", error);
		}
...
function seleniumStart(wct, opts) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		console.log("opts installlllllll? ", opts);
		if (opts.install) {
			try {
